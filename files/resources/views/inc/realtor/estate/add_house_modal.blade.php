<div class="modal fade" id="addHouseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="col-lg-4">
                                    <label for="type"><b class="burgundy">* </b>Type:</label>
                                        ...
                                        <div class="input-group">
                                                ...
                                                <select id="type" name="house_type_id" class="form-control" required >
                    ...
                    <!-- NO OF BEDROOMS -->
                            <div class="col-lg-4" id="bedrooms">
                                    ...
                                    <div class="input-group">
                                            ...
                                            <input name="bedrooms" type="number" required class="form-control" id="bedrooms" size="2" maxlength="2" placeholder="No of bedrooms" value="{!! old('bedrooms') !!}" />
                                    </div> 
                            </div>
