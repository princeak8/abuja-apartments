	 ...
	 <div id="main-content" class="col-md-10 col-sm-10">
        <div class="panel panel-default">
            ...
            <div class="panel-body color company">
            	...
            	<h4> Estates Portfolio <span class="fa fa-angle-right"></span> <a href="{{url('realtor/add_estate')}}"><small class="smll">Add Estate <span class="fa fa-plus-square"></span></small></a></h4>
							...
							<div class="col-md-3 col-sm-3 col-xs-6 no-padding est_xs">
								<div class="est_img">
									<a href="{{url('realtor/estate/'.$estate->id)}}">
		                                ...
		                                @elseif(App\Estate_photo::GetEstatePhoto($estate->id)->count())
