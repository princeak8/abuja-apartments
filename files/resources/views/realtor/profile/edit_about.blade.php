...
<div class="container">
    <div class="row">
        ...
        <div class="col-9">
            ...
            {!! Form::model($realtor, ['action' => ['Realtor\ProfileController@update_about'], 'method'=>'PATCH', 'autocomplete'=>'off']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-10">
                        {!! Form::textarea('about', null, ['placeholder'=>'About Me', 'id'=>'about', 'class'=>'form-control', 'required']) !!}
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-sm-12">
                        <button type="submit" name="submit" value="Change" class="btn-info form-control"><i class="fa fa-check-square"></i> Edit About Me</button>
                    </div>
