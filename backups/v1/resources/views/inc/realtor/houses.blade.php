...
<div id="portfolio-grid" class="">            
    <div id="available" class="col-md-12 col-sm-12 col-xs-12 houses">
    	@if($realtor->AllMyhouses->count()==0) 
            <p> No Houses yet under this portfolio </p>
        @else
            <ul class="no-padding">
            	@foreach($houses as $realtorHouse) 
...
<div id="shared" class="houses">
    ...
    <div class="table-responsive no-margin table1">
		<table class="table table-responsive">
            ...
            <?php $n = 0; ?>
            @foreach($realtor->mySharedHouses as $realtorHouse) <?php $n++; ?>
                <tbody>
                    ...
                    <td class="col-sm-7 col-xs-6">
                        ...
                        <p class="col-sm-6 share_p">
                            ...
                            <span class="fa fa-map-marker"></span> {{$realtorHouse->house->location}}
                        </p>
                    </td>
                    <td class="col-sm-4 col-xs-6 xs_small">
                       <div class="sh_img_sm shadow1">
                        <div class="shared_imgs col-sm-5">
                            <img class="img-responsive" src="{{env('APP_STORAGE')}}images/profile_photos/{{$realtorHouse->sharer->profile_photo}}" />
                        </div>
                        <div class="col-sm-7 no-padding re">
                            <h5><span class="hidden-xs fa fa-angle-double-right"></span> {{$realtorHouse->Sharer->name}}</h5>
                        </div>
                        <div class="clear"></div>
                       </div>
                    </td>
